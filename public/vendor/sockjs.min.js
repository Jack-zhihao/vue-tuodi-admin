        ...
        function(t, e, n) {
          ...
          e.exports = function(t, e) {
            ...
            e.forEach(function(t) {
              t.facadeTransport &&
                (n[t.facadeTransport.transportName] = t.facadeTransport);
            }),
              (n[a.transportName] = a);
            var c;
            t.bootstrap_iframe = function() {
              ...
              var a = function(i) {
                if (
                  i.source === parent &&
                  (void 0 === c && (c = i.origin), i.origin === c)
                ) {
                  var a;
                  try {
                    a = o.parse(i.data);
                  ...
                  if (a.windowId === l.currentWindowId)
                    switch (a.type) {
                      case "s":
                        ...
                        if (
                          !r.isOriginEqual(p, u.href) ||
                          !r.isOriginEqual(v, u.href)
                        )
                          throw new Error(
            ...
            a(r, y),
              ...
              (r.prototype._transportMessage = function(t) {
                ...
                switch (r) {
                  ...
                  case "h":
                    return (
                      this.dispatchEvent(new b("heartbeat")),
                      void this.transport
                    );
                }
                if (i)
          ...
          b(
            a,
            {
              indexOf: function(t) {
                ...
                var i = 0;
                for (
                  arguments.length > 1 && (i = r(arguments[1])),
            ...
            ? (function() {
                ...
                c.split = function(e, n) {
                  ...
                  var o,
                    ...
                    d = 0;
                  for (
                    e = new RegExp(e.source, f + "g"),
                      r += "",
                      t || (o = new RegExp("^" + e.source + "$(?!\\s)", f)),
                      n = void 0 === n ? -1 >>> 0 : i(n);
                    (s = e.exec(r)) &&
                    !(
      ...
      40: [
        function(t, e, n) {
          ...
          i(r, o),
            (r.enabled = function(t) {
              return (
                !t.cookie_needed && !t.nullOrigin && (a.enabled && t.sameScheme)
              );
            }),
      ...
      41: [
        function(t, e, n) {
          ...
          i(r, o),
            (r.enabled = function(t) {
              return (
                !t.nullOrigin && (!(!l.enabled || !t.sameOrigin) || a.enabled)
              );
            }),
      ...
      50: [
        function(t, e, n) {
          ...
          e.exports = {
            string: function(t) {
              for (
                var e = i.length, n = r.randomBytes(t), o = [], s = 0;
                s < t;
                s++
              )
                ...
                return (
                  ...
                  t.forEach(function(t) {
                    if (
                      ...
                      return e.length && -1 === e.indexOf(t.transportName)
                        ? void t.transportName
                        : void (t.enabled(n)
                            ? (t.transportName,
                              r.main.push(t),
                              t.facadeTransport &&
                        ...
                        try {
                          c =
                            ...
                            '"-000001-01-01T00:00:00.000Z"' ==
                              l(new u(-621987552e5)) &&
                            '"1969-12-31T23:59:59.999Z"' == l(new u(-1));
                        } catch (t) {
                          c = !1;
                        }
                      }
                    ...
                    e.stringify = function(t, e, n) {
                      ...
                      if (s[typeof e] && e)
                        if ("[object Function]" == (a = y.call(e))) i = e;
                          ...
                          o = {};
                          for (
                            var l, u = 0, c = e.length;
                            u < c;
                            l = e[u++],
                              ("[object String]" == (a = y.call(l)) ||
                                "[object Number]" == a) &&
                                (o[l] = 1)
                          );
                        }
                        ...
                        for (var t, e, n, r, i, o = N, s = o.length; C < s; )
                          switch ((i = o.charCodeAt(C))) {
                            ...
                            default:
                              if (
                                ((e = C),
                                45 == i && ((r = !0), (i = o.charCodeAt(++C))),
                                i >= 48 && i <= 57)
                              ) {
                                for (
                                  48 == i &&
                                    (i = o.charCodeAt(C + 1)) >= 48 &&
                                    i <= 57 &&
                                    I(),
                                    r = !1;
                                  C < s &&
          ...
          function o(t, e, n) {
            ...
            for (
              ...
              (d = m[g]),
                ...
                f !== f
                  ...
                  ? ~(p = t.indexOf(f)) &&
                    ("number" == typeof d[2]
                      ? ((y[v] = t.slice(0, p)), (t = t.slice(p + d[2])))
                      : ((y[v] = t.slice(p)), (t = t.slice(0, p))))
                  : (p = f.exec(t)) &&
                    ((y[v] = p[1]), (t = t.slice(0, p.index))),
                (y[v] = y[v] || (s && d[3] ? e[v] || "" : "")),
            ...
            n && (y.query = n(y.query)),
              s &&
                ...
                (y.pathname = i(y.pathname, e.pathname)),
