 ...
 * @LastEditTime: 2020-03-10 09:33:22
 -->
<template>
    ...
    <td-content-header
      ...
      <template v-slot:btns>
        <div class="header__ops">
          ...
          <el-button
            :disabled="
              multipleYDOrderSelection.length === 0 ||
                multipleYDOrderSelection.length > 1
            "
            size="mini"
            type="primary"
            @click="pathUrgPage"
          >
            <icon-svg icon-class="icon-btn-ico-14" />催缺信息
          </el-button>
          <el-button
            size="mini"
            type="primary"
      ...
      <div class="content__header">
        <div class="header__line">
          ...
          <el-input
            ...
            @keydown.enter.native="initYDOrderList"
          ></el-input>
  ...
  methods: {
    ...
    pathUrgPage() {
      this.$router.push({
        name: "acq_cqxx",
        query: {
          ydpcid: this.multipleYDOrderSelection[0]
        }
      });
    }
  },
