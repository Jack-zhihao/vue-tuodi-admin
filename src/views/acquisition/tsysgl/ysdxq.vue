 ...
 * @Date: 2019-03-19 16:54:02
 * @LastEditTime: 2020-03-10 09:36:50
 -->

<template>
  <div class="acq-ysdxq common__content">
    <td-content-header>
      验收单详情<span v-show="yspcCode">【验收单：{{ yspcCode }}】</span>
    ...
    <div class="content">
      ...
      <div class="content__table" ref="literatureTable">
        ...
        >
          ...
          <el-table-column show-overflow-tooltip prop="cjPrice" label="单价">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="tjPrice" label="套价">
          </el-table-column>
          <el-table-column
            show-overflow-tooltip
            prop="fuben"
...
import { YSDXQ_OPTIONS } from "utils/selectOptions";
...
export default {
  ...
  data() {
    ...
    this.filterOptions = YSDXQ_OPTIONS;
    this.formRules = {
