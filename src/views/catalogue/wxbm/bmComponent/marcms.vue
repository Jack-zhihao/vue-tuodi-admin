 ...
 * @Date: 2019-03-14 09:09:34
 * @LastEditTime: 2020-03-10 17:13:24
 -->

<template>
  <div class="c-marcms" tabindex="1" style="outline: none;" ref="marcmsWrapper">
    <!-- 字段帮助开始 -->
          ...
          >
            ...
            >
              ...
              <el-select
                ...
                :multiple-limit="
                  item.keyLength
                    ? item.subFieldLength / item.keyLength
                    : item.subFieldLength
                "
                placeholder="请选择"
                @change="
      ...
      <div class="header__line">
        <div>
          ...
          <el-checkbox
            ...
            storageId="1583461201981"
            v-model="needShowTips"
            @change="setLocalStorageObj('1583461201981', needShowTips)"
            >字段帮助</el-checkbox
          >
        </div>
      </div>
...
export default {
  ...
  mounted() {
    this.frameInitialX = this.$refs.marcmsWrapper.clientWidth - 640;
    document
      .querySelector(".c-marcms")
  ...
  data() {
    ...
    return {
      frameInitialX: 0,
      needShowTips: this.getLocalStorageObj("1583461201981"),
