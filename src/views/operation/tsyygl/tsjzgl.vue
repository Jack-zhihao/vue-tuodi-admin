 ...
 * @LastEditTime: 2020-03-06 14:03:20
 -->

<template>
  <div class="tsjzgl common__content">
    <td-content-header>
      捐赠管理列表
      ...
      <div class="content__header">
        <div class="header__line">
          ...
          <el-input
            ...
            @keydown.enter.native="initDonateList"
          ></el-input>
          <p class="label">状态：</p>
          <el-select
            filterable
          ...
          >
            <el-option
              v-for="item in statusListSelect"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            >
...
import { TSJZGL_OPTIONS } from "utils/selectOptions";
export default {
  name: "opera_tsjzgl",
  data() {
    this.literatureFilterOptions = TSJZGL_OPTIONS;
